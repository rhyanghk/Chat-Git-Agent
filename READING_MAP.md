...
| --- | --- | --- | --- |
| Human | START_HERE.md、00_CHAT_CONTROL/PROJECT_INSTRUCTIONS.md | Human 角色规则、控制资料 | Agent Skill、无关业务仓库 |
| Global Architect | CONSTITUTION.md、READING_MAP.md、NAMESPACE.md | Workspace Bootstrap、控制资料、明确依赖 | 所有项目代码和全历史 |
| Project Architect | CONSTITUTION.md、任务与项目约束 | AGENT_INTERFACE、控制记录、GitHub 中继 | 其他项目与完整 Agent Skill |
...
| 首次使用 Chat 平台 | START_HERE.md、00_CHAT_CONTROL/README.md | 对应 PLATFORM_ADAPTER | Agent Skill 全文 |
